      ...
      <section>
        <section className={style.profile__wrapper}>
          <div className={style.profile}>
            <Image loading="eager" priority={true} src={PROFILE} alt={'profile'} width={100} height={100} />
          </div>
        ...
        <section className={style.profile__information}>
          <div className={'flex-align-center pb-8'}>
            <Image loading="eager" priority={true} src={EMAIL} alt={'profile'} width={18} height={18} />
          ...
          <div className={'flex-align-center pb-8'}>
            <Image loading="eager" priority={true} src={GITHUB} alt={'profile'} width={18} height={18} />
          ...
          <div className={'flex-align-center pb-8'}>
            <Image loading="eager" priority={true} src={TWITTER} alt={'profile'} width={18} height={18} />
